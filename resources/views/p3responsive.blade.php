    ...
    <div class="container">
        ...
        <div class="jumbotron">
            ...
            <p class="lead text-right">
                <a class="btn btn-primary btn-lg" href="Jumbo action link" role="button">Klik Disini</a>
            </p>
        </div>
        <!----contoh grid 1---->
        <div class="row">
        ...
        <div class="row">
            <div class="col-8">
                <p class="open-sans-tentang"><b>Danantara Indonesia</b> merupakan badan pengelola investasi yang
            ...
            <div class="col-4">
                ...
                <div class="row">
                    <div class="col">
                        <p> <a href="https://www.danantaraindonesia.co.id/id/about"><br>Pelajari Lebih Lanjut</br></a>
                        </p>
                    </div>
                </div>
            </div>
