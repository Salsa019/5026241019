...
<body>
    <p>RoboDog Kendali Jarak Jauh, Inovasi ITS bersama Indosat, Nokia, dan NVIDIA</p>

    <p class="publis">Published on<br>
        Minggu, 1 Maret 2026</p>

    <center><img class="gambar"
    ...
    <p class="agakmasuk">Surabaya, ITS News — <a href="https://www.its.ac.id/" target="_blank">Institut Teknologi
            Sepuluh Nopember (ITS)</a> kembali menegaskan kapasitasnya dalam pengembangan
    ...
    <p>Dalam skenario demonstrasi, RoboDog di Surabaya, Indonesia dapat menerima perintah suara dari pengguna di
        Barcelona,
        Spanyol untuk memeriksa kondisi suatu lokasi, mendeteksi potensi bahaya, hingga memastikan tidak ada aktivitas
        mencurigakan. Mahasiswa Departemen Teknik Komputer ITS tersebut menilai bahwa kemampuan robot untuk memahami
        situasi
        membuatnya aplikatif untuk industri yang berisiko tinggi bagi manusia.</p>
    ...
    <p class="publis">Perwakilan Pengembang RoboDog menyimulasikan tampilan user interface RoboDog ketika robot
        dikendalikan dari
        Barcelona, Spanyol.</p>
